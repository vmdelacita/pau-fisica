% A la pauta original la numeració continua des de la sèrie 1 (criteris 12-22).
\begin{enumerate}
  ...
  \item Un resultat amb un nombre molt elevat de xifres significatives (6 xifres significatives) o amb poques xifres significatives (2 o menys) es penalitzarà amb 0,1\,p.
\end{enumerate}
