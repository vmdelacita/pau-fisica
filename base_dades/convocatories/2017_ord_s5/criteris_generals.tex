...
\begin{enumerate}
  ...
  \item Cal resoldre els exercicis fins al resultat final i no es poden deixar indicades les operacions. Tanmateix, els errors en el càlcul restaran el 20\% de la puntuació d'aquest apartat. Exemple: Si un apartat val 1 punt i s'ha equivocat en les càlculs li haurem de puntuar 0,8 punts.
