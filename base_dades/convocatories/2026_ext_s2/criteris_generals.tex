\begin{enumerate}
  ...
  \item Un o més resultat amb un nombre molt elevat de xifres significatives (6 xifres significatives) o amb només una xifra significativa es penalitzarà amb 0,1p en aquest problema..
\end{enumerate}
