...
% "°" també dins de fórmules (sense això es perd sense avisar)
...
% Puntuació parcial de la pauta: \punts{0,75} (amb \mostrapuntsfalse no es mostra)
\newcommand{\punts}[1]{\ifmostrapunts\textcolor{red!70!black}{\textbf{#1\,p}}\ \else\ignorespaces\fi}
